...
UPDATE_PACKAGE "luci-app-advanced-reboot" "immortalwrt/luci" "master" "applications/luci-app-advanced-reboot"
UPDATE_PACKAGE "luci-app-ttyd" "immortalwrt/luci" "master" "applications/luci-app-ttyd"
UPDATE_PACKAGE "luci-app-openclash" "immortalwrt/luci" "master" "applications/luci-app-openclash"
